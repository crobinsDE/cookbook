...
/**
 * Enable access to update.php even if you're not logged in.
 */
#$settings['update_free_access'] = TRUE;

/**
 * Try to override the memory limit.
 *
 * This can be useful if you're getting out of memory errors when trying to
 * rebuild cache, but many webservers will get really angry at this directive.
 */
...
/**
 * Enable Browsersync (via Browsersync contrib module).
 *
 * Enables Browsersync globally (for all themes). You then need to allow
 * anonymous and authenticated users to use browsersync (Drupal permission).
 */
